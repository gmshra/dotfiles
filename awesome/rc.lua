...
beautiful.init(string.format("/home/gm/.config/awesome/themes/gm_tokyonight/theme.lua",os.getenv("HOME"), chosen_theme))
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "b", function ()
        ...
        {description = "toggle bottom tasklist", group = "awesome"}),
